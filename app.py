...
def fetch_from_hubspot():
    ...
    url = "https://api.hubapi.com/crm/v3/objects/contacts?limit=100&properties=CLOSER,NAME,DATE,MBI NUMBER,CARRIER,SEP,STATE,LANGUAGE,STATUS"
...
if selected_agent:
    ...
    agent_snapshot = snapshot[snapshot["CLOSER"].str.upper() == selected_agent.upper()]
else:
...
for month in months:
    ...
    trailing_df = snapshot[
        ...
        (snapshot["CLOSER"].str.upper() == selected_agent.upper()) &
